          ...
          <div className="row">
            <div className="col-sm-6 text-black">
              ...
              <div className="px-5 ms-xl-4">
                <br/>
                <span className="h1 fw-bold mb-0">Sistema Bancario<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-airplane" viewBox="0 0 16 16">
